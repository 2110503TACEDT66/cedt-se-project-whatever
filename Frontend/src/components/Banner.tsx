  ...
  return (
    <div className="flex-col p-[5px] m-0 w-screen h-[100vh] relative items-center text-center">
      <div className="relative top-24 z-20 text-center">
        <h1 className={`text-6xl p-4 rounded-lg font-semibold font-body ${session?.user.role == "receptionist" ? "text-rose-700":"text-cyan-800"}`}>Welcome to Dentist Booking</h1>
        <div className={`text-xl font-serif italic ${session?.user.role == "receptionist" ? "text-rose-900":"text-cyan-900"} mt-6`}>Your perfect choice for dentist booking</div>
